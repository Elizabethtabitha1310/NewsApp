 ...
 private suspend fun headlinesInternet(countryCode: String){
     ...
     try {
         if (internetConnection(this.getApplication())){
             val response = newRepository.getHeadlines(countryCode,headlinesPage)
    ...
    private suspend fun searchNewsInternet(searQuery:String){
newSearchQuery = searQuery
        searchNews.postValue(Resource.Loading())
        try {
            if (internetConnection(this.getApplication())){
                val response = newRepository.getHeadlines(searQuery,searchNewsPage)
